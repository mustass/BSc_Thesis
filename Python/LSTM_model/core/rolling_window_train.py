...
def rolling_window(model_config, datasetName, start_from, restart, restart_window,
                   window_length, timesteps, max_epochs, data_folder ,save_folder, col ='log_ret',returns = True):
    ### Model:
    ...
    while end_of_window + i + 1 < end_of_loop:
        ...
        print(save_folder)
        path_to_checkpoint = save_folder +  datasetName+'/' + 'checkpoint' + str(i) + '.pth.tar'
