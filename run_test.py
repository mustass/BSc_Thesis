...
Nice_model_trained, loss_train, loss_test = train_model(Nice_model, Nice_loss, Nice_optimiser, 1,training_generator,
                                                       test_generator, 50, 1)

ys, ys_testing, loss_vals_test,loss_vals_train = eval_model(Nice_model_trained,Nice_loss, train_dt,test_dt,50)
