...
path = '/home/s/Dropbox/KU/BSc Stas/Python/Try_again/rolling_window_results_3yr/DJI'

result = pickle.load(open( '/home/s/Dropbox/KU/BSc Stas/Python/Try_again/rolling_window_results/DJI/outputDGI.csv.obj', "rb" ))
